...
<main class="form-signin w-25 mx-auto">
  <form method="post">
    <img class="mb-4 rounded-circle shadow" src="<?=ROOT?>/assets/imgs/C.png" alt="" width="72" height="57">
    <h1 class="h3 mb-3 fw-normal">Create Account</h1>

    <div class="form-floating">
      <input name="username" type="text" class="form-control" id="floatingInput" placeholder="JohnDoe123">
    ...
    <div class="form-floating">
      <input type="password" name="retype_password" class="form-control mb-2" id="floatingPassword" placeholder="Retype Password">
    ...
    <button class="btn btn-primary w-100 py-2" type="submit">Sign Up Now</button>
